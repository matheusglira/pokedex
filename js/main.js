...
function createPokemonCard(pokemon) {
    ...
    const name = pokemon.name[0] + pokemon.name.slice(1);
    const poke_status = pokemon.stats.map((el) => el.stat.name);
    const stats = poke_status.slice(0, 3);
    ...
    <img src="https://nexus.traction.one/images/pokemon/pokemon/${pokemon.id}.png"/>
    </div>
    <div class="info">
